...
const Footer = () => {
  const primaryGradient =
    "bg-gradient-to-r from-teal-800 via-blue-900 to-indigo-800";
      ...
      <div className="container mx-auto px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          <h3 className={`text-xl font-semibold ${headingColor} mb-4`}>
            About NERIST Conf. 2025
          </h3>
          <p className={`text-sm leading-relaxed mb-4 ${textColor}`}>
            [Insert a brief, compelling description of NERIST Conf. 2025 here.
            You can take inspiration from the "About Us" section of the 2024
            website, focusing on the key aspects and benefits of attending.]
          </p>
          <p className="text-sm">
        ...
        <div>
          ...
          <ul className={`text-sm space-y-2 ${textColor}`}>
            <li>
              <Link
                to="/important-dates"
                className={`${linkHighlight} hover:underline`}
              >
                Important Dates
              </Link>
            </li>
        ...
        <div>
          ...
          <p className={`text-sm leading-relaxed mb-2 ${textColor}`}>
            ...
            <Link
              to="mailto:[Your Conference Email]"
              className={`${linkHighlight} hover:underline`}
            >
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <Link
              to="[Your Facebook Link]"
              className={`text-gray-400 hover:text-teal-300 hover:underline`}
            >
              <FaFacebook size={24} />
            </Link>
            <Link
              to="[Your Twitter Link]"
              className={`text-gray-400 hover:text-teal-300 hover:underline`}
            >
              <FaTwitter size={24} />
            </Link>
            <Link
              to="[Your LinkedIn Link]"
              className={`text-gray-400 hover:text-teal-300 hover:underline`}
            >
              <FaLinkedin size={24} />
            </Link>
            ...
            <div
              className="mt-4"
              dangerouslySetInnerHTML={{ __html: statcounterCode }}
            />
          </div>
        </div>
      </div>
      <div
        className={`mt-8 py-4 border-t ${borderColor} text-center text-sm ${copyrightColor}`}
      >
        <p>
          &copy; {new Date().getFullYear()} NERIST Conf. 2025. All Rights
          Reserved.
        </p>
        <p>
          Designed & Developed by{" "}
          <Link
            to="[Your Organization/Developer Link]"
            className={`${linkHighlight} hover:underline`}
          >
            Ajit Kumar Roy
          </Link>

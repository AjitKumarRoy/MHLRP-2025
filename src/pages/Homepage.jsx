...
const deemedUniversity =
  "Deemed-to-be University under the Ministry of Education, Government of India";
const aboutText =
...
const homepageDescription =
  "Join MHLRP 2025 on November 6-7, 2025, at NERIST, Arunachal Pradesh, to explore mental health solutions for peripheralized communities. Submit abstracts by July 31, 2025.";
...
const callForPapersLink = "/call-for-papers";
const cmtLink =
  "https://cmt3.research.microsoft.com/User/Login?ReturnUrl=%2FMHLRP2025"; // Or /paper-submission
const sponsors = [
  sponsor1Logo,
  sponsor2Logo,
  sponsor1Logo,
...
const Homepage = () => {
  ...
  return (
    ...
    >
      <Helmet>
        <title>
          Home | {conferenceShortForm}: Mental Health Conference | NERIST
        </title>
      ...
      <section className="relative py-24 md:py-48 bg-cover bg-center overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          >
            <Link
              to="https://cmt3.research.microsoft.com/User/Login?ReturnUrl=%2FMHLRP2025"
              target="_blank"
      ...
      <ScrollingNotification
        text="📢 6th & 7th November, 2025. Mark your calendars!    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; —  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 📝 Paper Submission Link is Active now!"
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                (CFTI) established in 1984. It is a deemed-to-be-university that
                is autonomous and fully funded by the Ministry of Education,
                Government of India. NERIST is the first Institute in the
                country to have adopted a modular pattern of engineering
                education which was later adopted by the Sant Longowal Institute
                of Engineering and Technology (SLIET), the Central Institute of
                Technology (CIT), Kokrajhar in Assam, and Ghani Khan Choudhury
                Institute of Technology (GKCIT), Malda, West Bengal.
                Representatives from the Ministry of Education, the Government
                of India, the eight North Eastern beneficiary states, AICTE, and
                education professionals comprise the Board of Management, which
                oversees the institute. The Governor of Arunachal Pradesh serves
                as the de facto head of the NERIST Society, with education
                ministers from every state in the Northeast as its members. The
                Chairman is in charge of the Board of Management. All the
                undergraduate programmes in engineering and applied sciences are
                accredited by the NBA, apart from the Indian Council of Forestry
                Research and Education (ICFRE) and the Indian Council of
                Agricultural Research (ICAR), wherever applicable.
              </p>
              <Link
                to={venueLink}
                className="text-indigo-500 hover:text-indigo-700 font-semibold transition duration-300"
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-8 text-center">
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                We invite researchers, scholars, and practitioners to submit
                their original and unpublished work to MHLRP 2025. Explore
                opportunities to share your innovative ideas and contribute to
                the advancement of Peripheralized Community.
              </p>
              {/* Added a div to contain and style the links */}
              <div className="flex flex-col items-center space-y-4 md:flex-row md:space-y-0 md:space-x-4 justify-center">
                <Link
                  ...
                  className="text-indigo-500 hover:text-indigo-700 font-semibold transition duration-300"
                >
                  Read Guidelines <span aria-hidden="true">&rarr;</span>
                </Link>
                <Link
                  to={cmtLink}
                  target="_blank"
